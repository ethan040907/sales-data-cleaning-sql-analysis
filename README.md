# Sales Data Cleaning, SQL Analysis, and Power BI Dashboard

## Project Overview
This project demonstrates an end-to-end data analysis workflow: cleaning a poorly structured Excel dataset, transforming it into a usable format, analyzing it using SQL, and visualizing insights through an interactive Power BI dashboard.
...
Power BI was then used to build an interactive dashboard to present key insights in a clear and business-friendly format.
...
To complement the SQL analysis, an interactive dashboard was built using Power BI to visualize key insights and enable dynamic exploration of the dataset.

The dashboard serves as a visual summary of the core business questions, allowing users to quickly understand sales performance and filter results by segment or year.
...
- **Total Revenue KPI**  
  Displays overall sales and dynamically updates based on selected filters  

- **Monthly Revenue Trend**  
  A line chart showing fluctuations in sales over time, highlighting irregular spikes and trends  

- **Sales by Customer Segment**  
  A bar chart comparing revenue across Consumer, Corporate, and Home Office segments  

- **Sales by Shipping Mode**  
  A breakdown of revenue contribution by shipping method  

- **Segment and Shipping Mode Breakdown**  
  A stacked bar chart illustrating how each segment contributes across shipping modes  

- **Yearly Revenue Overview**  
  A summary of total sales by year  
...
This project demonstrates a complete data workflow: transforming messy raw data into a structured dataset, analyzing it using SQL, visualizing insights using Power BI, and translating results into clear, business-focused insights.
